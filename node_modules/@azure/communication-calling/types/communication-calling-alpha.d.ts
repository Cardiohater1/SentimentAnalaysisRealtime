...
export declare interface Call extends CallCommon {
     ...
     * @returns The RemoteParticipant object associated with the successfully added participant.
     */
    addParticipant(identifier: MicrosoftBotIdentifier): RemoteParticipant;
    /**
     * Add a participant to this Call.
     * @param identifier - The identifier of the participant to add.
 ...
 * @alpha
 */
export declare type CallInformationContext = 'transferToParticipant' | 'transferToCall' | 'escalation' | 'roomJoin' | 'groupJoin' | 'teamsMeetingJoin' | '';

/**
 * @alpha
 */
export declare type CallInformationIdentifierKind = 'microsoftTeamsUser' | 'phoneNumber' | 'communicationUser' | 'unknown' | 'microsoftBot';
 ...
 * @beta
 */
export declare type ConnectionState = 'Connected' | 'Disconnected' | 'Connecting';
 ...
 * @beta
 */
export declare type ConnectionStateChangedReason = 'tokenExpired' | 'signalingIssue';
...
export declare interface LiveStreamStatsSummaryItem {
    audioBitrate?: MediaStatValue;
    videoBitrate?: MediaStatValue;
    downloadBitrate?: MediaStatValue;
    bufferLengthInMs?: MediaStatValue;
    videoHeight?: MediaStatValue;
    videoWidth?: MediaStatValue;
    currentPlayPosition?: MediaStatValue;
}
 ...
 * @public
 */
export declare type ParticipantCapabilityName = 'turnVideoOn' | 'unmuteMic' | 'shareScreen' | 'removeParticipant' | 'hangUpForEveryOne' | 'addCommunicationUser' | 'addTeamsUser' | 'addPhoneNumber' | 
...
export declare type TransferRequestedEventArgs = {
    targetParticipant: CommunicationIdentifierKind;
